...
experimento  =  1
name_modelo  = 'modelo1_experimentacion_parte_2'
csv_name     = 'modelo_'+str(experimento)+'experimentacion_parte_2'

notas        = "En la parte 1 y la dos se diferencian por el padding"
...
name = 'modelo_1_experimentacion_parte_2.csv'
