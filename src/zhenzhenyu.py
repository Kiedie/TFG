...
def ZhengZhenyu2(include_top=True,
                weights=None,
                input_tensor=None,
                input_shape=None,
                classes=5,
    ...
    x = layers.Dense(units=32, activation=keras.activations.elu)(x)
    x = layers.Dropout(rate=0.5)(x)
    x = layers.Dense(units=classes, activation=keras.activations.elu)(x)
...
experimento  =  3
name_modelo  = 'ZhengZhenyu'
csv_name     = 'ZhenZhenyu_'+str(experimento)
notas        = "Vamos a cambiar el include top a ver si por algún causal mejorase"
...
dict_parameters =  {'include_top'  :False, 
                    'weights'      :None, 
                    'input_tensor' :None,
...
# Creación de modelo
model = ZhengZhenyu2(include_top    = dict_parameters['include_top'],
                weights               = None,
                input_tensor          = None,
